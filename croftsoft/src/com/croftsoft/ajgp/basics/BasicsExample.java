...
//////////////////////////////////////////////////////////////////////
{
  ...
  private static final String VERSION = "2003-11-06";

  private static final String TITLE = "CroftSoft Basics";
  ...
  private static final Font FONT = new Font("Arioso", Font.BOLD, 20);

  private static final Double FRAME_RATE = new Double(30.0);
  ...
  private static final String AUDIO_FILENAME = MEDIA_DIR + "drip.wav";

  private static final String IMAGE_FILENAME = MEDIA_DIR + "croftsoft.png";
  ...
  //////////////////////////////////////////////////////////////////////
  //////////////////////////////////////////////////////////////////////
  // private static BasicsExample basicsExample = new BasicsExample();
  ...
  //////////////////////////////////////////////////////////////////////
  {
    ...
    if (rolling) {
      ...
      if (ballRectangle.x > componentBounds.width - ballRectangle.width) {
        ballRectangle.x = componentBounds.width - ballRectangle.width;
      }

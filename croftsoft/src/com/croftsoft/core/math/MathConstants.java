     ...
     *********************************************************************/
     ...
     public static final double  GOLDEN_RATIO = 1.618033988749894848204586;

     public static final long    MILLISECONDS_PER_SECOND = 1000;

     public static final long    MILLISECONDS_PER_DAY
       = MILLISECONDS_PER_SECOND * 60 * 60 * 24;

     public static final long    NANOSECONDS_PER_MILLISECOND = 1000000;

     public static final long    NANOSECONDS_PER_SECOND = 1000000000;

     public static final double  SECONDS_PER_NANOSECOND = 0.000000001;
